    ...
    return (
        <footer className="bg-sky-300 flex flex-col">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-8">
                <a href="https://www.facebook.com/AesopRockWins/" className="bg-white rounded-full p-4 hover:bg-gray-100 transition-colors flex items-center justify-center">
                    <Facebook className="w-8 h-8 text-gray-800" />
                    <span className="sr-only">Facebook</span>
                </a>
                <a href="https://x.com/aesoprockwins" className="bg-white rounded-full p-4 hover:bg-gray-100 transition-colors flex items-center justify-center">
                    <svg className="w-8 h-8 text-gray-800" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                    <span className="sr-only">X (Twitter)</span>
                </a>
                <a href="https://www.instagram.com/aesoprockwins/" className="bg-white rounded-full p-4 hover:bg-gray-100 transition-colors flex items-center justify-center">
                    <Instagram className="w-8 h-8 text-gray-800" />
                    <span className="sr-only">Instagram</span>
                </a>
                <a href="https://www.youtube.com/playlist?list=PLA435A660B8CAE07A" className="bg-white rounded-full p-4 hover:bg-gray-100 transition-colors flex items-center justify-center">
                    <Youtube className="w-8 h-8 text-gray-800" />
                    <span className="sr-only">YouTube</span>
                </a>
                <a href="https://www.tiktok.com/@aesoprocktok?_t=ZN-8xuGWol6NPi&_r=1" className="bg-white rounded-full p-4 hover:bg-gray-100 transition-colors flex items-center justify-center">
                    <svg className="w-8 h-8 text-gray-800" viewBox="0 0 24 24" fill="currentColor">
